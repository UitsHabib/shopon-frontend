...
import { UserClientRoutes, Login, Logout, Dashboard, ForgotPassword, ResetPassword, MyProfile, UserForm, UpdateMyProfile, userReducer } from './user';
...
export { Login, Logout, Dashboard, ForgotPassword, ResetPassword, MyProfile, UserForm, Profiles, CreateProfile, UpdateMyProfile, userReducer };
